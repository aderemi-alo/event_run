...
import 'package:event_run/features/events/data/repositories/event_requirement_repository_impl.dart';
...
import 'package:event_run/features/events/domain/usecases/get_event_requirements.dart';
import 'package:event_run/features/events/domain/usecases/add_event_requirement.dart';
import 'package:event_run/features/events/domain/usecases/check_inventory_conflicts.dart';
...
// Repository
final eventRequirementRepositoryProvider =
    Provider<EventRequirementRepository>((ref) {
  return EventRequirementRepositoryImpl(
      ref.watch(eventRequirementRemoteDatasourceProvider));
});

// Usecases
final getEventRequirementsUsecaseProvider =
    Provider<GetEventRequirements>((ref) {
  return GetEventRequirements(ref.watch(eventRequirementRepositoryProvider));
});

final addEventRequirementUsecaseProvider =
    Provider<AddEventRequirement>((ref) {
