...
import 'package:app/features/vendor/data/repositories/subscription_repository_impl.dart';
...
import 'package:app/features/vendor/domain/usecases/upgrade_to_pro.dart';
...
final subscriptionEventsProvider = FutureProvider.autoDispose
    .family<List<SubscriptionEventEntity>, String>((ref, vendorId) {
      return ref
          ...
          .getSubscriptionEvents(vendorId);
    });
